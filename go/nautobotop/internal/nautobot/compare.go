...
func CompareJSONFields(existing, desired interface{}) bool {
...
func compareJSONMaps(existing, desired map[string]interface{}) bool {
...
func compareJSONValues(existing, desired interface{}) bool {
	// Handle nil values
	if desired == nil {
		return existing == nil
	}
	...
	// For primitive values (string, number, boolean), direct comparison
	// JSON unmarshaling normalizes numbers to float64
...
func comparePrimitiveValues(existing, desired interface{}) bool {
...
func compareNestedObjectWithPrimitive(existingMap map[string]interface{}, desired interface{}) bool {
...
//
// Note: "id" takes precedence over "value" if both exist
func comparePrimitiveWithNestedObject(existing interface{}, desiredMap map[string]interface{}) bool {
