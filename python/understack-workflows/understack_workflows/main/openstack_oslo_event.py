...
_event_handlers: dict[str, EventHandler | list[EventHandler]] = {
    ...
    "baremetal.node.create.end": ironic_node.handle_node_create_update,
    "baremetal.node.update.end": ironic_node.handle_node_create_update,
    "baremetal.node.delete.end": ironic_node.handle_node_delete,
