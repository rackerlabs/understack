...
def test_find_or_create():
  ...
  'interfaces': [{'connected_interface': {'device': {'id': '275ef491-2b27-4d1b-bd45-330bd6b7e0cf',
                                                     ...
                                                     'rel_vlan_group_to_devices': {'rel_vlan_group_to_devices': [{'id': '275ef491-2b27-4d1b-bd45-330bd6b7e0cf',
                                                                                                                  'name': 'f20-2-1.iad3.rackspace.net'},
                 ...
                 {'connected_interface': {'device': {'id': '05f6715a-4dbe-4fd6-af20-1e73adb285c2',
                                                     'location': {'id': 'da47f07f-b66a-4f0c-b780-4be8498e6129'},
                                                     'name': 'f20-2-2.iad3.rackspace.net',
                                                     'rack': {'id': '1ccd4b4a-7ba3-4557-b1ad-1ba87aee96a6'},
                                                     'rel_vlan_group_to_devices': {'rel_vlan_group_to_devices': [{'id': '275ef491-2b27-4d1b-bd45-330bd6b7e0cf',
                 ...
                 {'connected_interface': {'device': {'id': '05f6715a-4dbe-4fd6-af20-1e73adb285c2',
                  ...
                  'status': {'id': 'd4bcbafa-3033-433b-b21b-a20acf9d1324'},
                  'type': 'A_25GBASE_X_SFP28'},
                 {'connected_interface': {'device': {'id': '275ef491-2b27-4d1b-bd45-330bd6b7e0cf',
                                                     'location': {'id': 'da47f07f-b66a-4f0c-b780-4be8498e6129'},
                                                     'name': 'f20-2-1.iad3.rackspace.net',
                                                     'rack': {'id': '1ccd4b4a-7ba3-4557-b1ad-1ba87aee96a6'},
                                                     'rel_vlan_group_to_devices': {'rel_vlan_group_to_devices': [{'id': '275ef491-2b27-4d1b-bd45-330bd6b7e0cf',
                  ...
                  'status': {'id': 'd4bcbafa-3033-433b-b21b-a20acf9d1324'},
                  'type': 'A_25GBASE_X_SFP28'},
                 {'connected_interface': {'device': {'id': '912d38b1-1194-444c-8e19-5f455e16082e',
                                                     'location': {'id': 'da47f07f-b66a-4f0c-b780-4be8498e6129'},
                  ...
                  'ip_addresses': [{'host': '10.46.96.156',
