...
The operator only ever creates, updates or deletes resources carrying one of
these markers. That is what makes it safe to run alongside flavors and profiles
a human created by hand.
