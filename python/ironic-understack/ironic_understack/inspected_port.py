...
@dataclass
class InspectedPort:
    """Represents the a parsed entry from Ironic inspection (inventory) data."""
    ...
    @property
    def parsed_name(self) -> tuple[str, str, str]:
        ...
        return rack_name, switch_suffix, data_center_name

    @property
    def rack_name(self) -> str:
        return self.parsed_name[0]

    @property
    def switch_suffix(self) -> str:
        return self.parsed_name[1]

    @property
    def data_center_name(self) -> str:
        return self.parsed_name[2]
