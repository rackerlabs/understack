...
!!! tip "If you deploy from `main`"
    ...
    [Unreleased](unreleased.md) page. It covers everything merged to `main`
...
- Within a version, notes are grouped under **Action required**, **Deploy repo
  changes**, **Deprecations and removals**, and **Notes**. A version with an
  **Action required** group needs a manual step; one without does not.
